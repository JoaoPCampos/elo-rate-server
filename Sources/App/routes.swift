...
public func routes(_ router: Router) throws {
    ...
    Route.playerRoutes(router)
    Route.gameRoutes(router)
}

private class Route {
    
    static func authRoutes(_ router: Router) {
    ...
    static func playerRoutes(_ router: Router) {
        ...
        router
            .grouped(APIMiddleware.simple)
            .get(EloRankingURL.baseURL,"/player/", Player.parameter, use: PlayerController.find)
    ...
    static func gameRoutes(_ router: Router) {
